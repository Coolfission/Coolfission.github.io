...
"resource": {
  ...
  "macros":[{
      ...
      "vtp_input":["macro",7],
      "vtp_map":["list",["map","key","\/","value","Harris Geospatial Solutions has more than 30 years of experience developing scientifically proven solutions using cutting-edge technology. Today, organizations across industries use our geospatial data \u0026 imagery tools and satellite mapping to make better decisions."],["map","key","\/Industry-Solutions","value","Whether you are a defense analyst who supplies actionable information to support a mission or a utilities professional who needs to efficiently maintain assets across a system, our data and software solutions give you the confidence to make better decisions."],["map","key","\/Industry-Solutions\/Academic","value","Top educators at learning institutions across North America use ENVI image analysis software as well as our scientific programming language IDL for cutting-edge research and to prepare students for careers in commercial, government, and defense organizations."],["map","key","\/Industry-Solutions\/Defense-Intelligence","value","Defense and intelligence personnel rely on our industry-leading software tools to turn geospatial imagery and data into timely, accurate, and actionable intelligence."],["map","key","\/Industry-Solutions\/Fed-Civil","value","Whether you want to extract buildings footprints, model flood plains, or provide actionable intelligence to first responders, we can provide a solution that meets your needs."],["map","key","\/Industry-Solutions\/Maritime","value","Harris has partnered with exactEarth Ltd to offer a full range of Satellite Automatic Identification System (S-AIS) data services and products."],["map","key","\/Industry-Solutions\/Precision-Agriculture","value","Ag businesses can tailor crop management decisions by using modern precision agriculture techniques \u0026 scientifically proven approaches that analyze remotely sensed data such as satellite and UAV imagery."],["map","key","\/Industry-Solutions\/Utilities","value","Harris has solutions that leverage remotely sensed data and powerful analytics that take utility asset management to the next level. Click in for more."],["map","key","\/Industry-Solutions\/Solutions-Delivery","value","Let our Enterprise Solutions Delivery team streamline your project \u0026 provide the answers you need using our project management tools, machine learning \u0026 cloud computing."],["map","key","\/Software-Technology","value","Whether you are looking for a finished geospatial product, a custom solution, or data and analytics to support a project, we can meet your needs."],["map","key","\/Software-Technology\/Deep-Learning","value","Harris Geospatial has developed a suite of deep learning-based tools called MEGA™ that are designed specifically to work with imagery to solve geospatial problems."],["map","key","\/Software-Technology\/ENVI","value","ENVI SARscape® allows you to easily process and analyze SAR data acquired from all existing spaceborne and selected airborne platforms. Generate products, and integrate information with other geospatial products."],["map","key","\/Software-Technology\/ENVI-SARscape","value","ENVI SARscape allows you to easily process and analyze SAR data acquired from all existing spaceborne and selected airborne platforms. Generate products, and integrate information with other geospatial products."],["map","key","\/Software-Technology\/Helios","value","Helios scalable cloud analytics services leverage a growing network of existing cameras to process imagery in real time using machine learning to instantaneously identify and classify changes in ground weather conditions."],["map","key","\/Software-Technology\/IDL","value","IDL is the trusted scientific programming language used across disciplines to extract meaningful visualizations from complex numerical data. With IDL you can interpret your data, expedite discoveries, and deliver powerful applications to market."],["map","key","\/Software-Technology\/Jagwire","value","Jagwire is a cloud \u0026 web-based geospatial data management software designed to quickly \u0026 easily analyze and transform data into actionable information."],["map","key","\/Software-Technology\/PrecisionPass","value","This toolkit lets pilots quickly determine if a data collection meets the required criteria or if it needs to be collected again. This immediate feedback reduces the risk of failures during the analysis stage, all but eliminating the need to re-fly a mission."],["map","key","\/Software-Technology\/Geospatial-Services-Framework","value","Geospatial Services Framework easily installs within existing infrastructure and takes advantage of the data assets an organization has already invested in."],["map","key","\/Data-Imagery","value","Harris Geospatial Solutions offers data, imagery, mapping services, and visual simulation products to enable scientific discovery, make important business decisions, and solve hard problems."],["map","key","\/Data-Imagery\/Aerial-Imagery","value","Access the best commercially available aerial photography that provides a higher level of detail than satellite imagery, almost complete absence of clouds, and is very cost effective in many cases – perfect for individuals, small businesses, farms, construction, real estate, and more."],["map","key","\/Data-Imagery\/Elevation-Data","value","Harris Geospatial offers a wide variety of in-house elevation datasets and has partnered with other leading providers such as Airbus and Intermap to provide multi-resolution DEM coverage for the entire globe."],["map","key","\/Data-Imagery\/Geiger-mode-LiDAR","value","Harris Geospatial now offers this high-resolution LiDAR data and products to commercial organizations and civil governments. Geiger-mode LiDAR provides point clouds on a larger scale and at a higher point density than has been possible up until now."],["map","key","\/Data-Imagery\/Mapping-Services","value","Harris Geospatial offers custom data, satellite \u0026 topographic mapping services for the most accurate imagery solutions \u0026 image orthorectification."],["map","key","\/Data-Imagery\/Satellite-Imagery","value","Harris Geospatial has partnered with the leading satellite imagery providers including Airbus, DigitalGlobe, and Planet to offer data for any location in the world."],["map","key","\/Data-Imagery\/Visual-Simulation","value","Our experts are standing by to help find the best visual simulation products for your needs. Click in to learn more."],["map","key","\/Learn","value","Learn how to get the most out of Harris Geospatial products and technoloy with our easy to use tools and resources."],["map","key","\/Learn\/CaseStudies.aspx","value","Our case studies represent a wide range of industries using Harris Geospatial solutions and products to solve critical challenges."],["map","key","\/Industry-Solutions\/Transportation","value","Harris Geospatial Transportation Analytics \u0026 IT solutions provide infrastructure management solutions for rail, highway, weather analytics \u0026 asset management."],["map","key","\/Company\/Events\/Tradeshows\/SAR-Analytics-Symposium","value","Join us in Rome Italy for the premier SAR analytics event designed to share real world applications from industry thought leaders \u0026 SAR  service providers"],["map","key","\/Company\/Events\/Tradeshows\/EAS","value","Join us in Denver, CO for a gathering of global thought leaders the geospatial analytics space. Learn about purpose built solutions to drive real results."],["map","key","\/eas\/","value","Join us in Denver, CO for a gathering of global thought leaders the geospatial analytics space. Learn about purpose built solutions to drive real results."],["map","key","\/Data-Imagery\/Services\/Aerial-Survey-Mapping-Services","value","Have an area too large for a ground survey? Aerial mapping \u0026 survey services from L3 Harris Geospatial allow for elevation, vector \u0026 triangulation data."]]
    },{
      "function":"__smm",
      "vtp_setDefaultValue":false,
      "vtp_input":["macro",7],
      "vtp_map":["list",["map","key","\/","value","L3Harris Geospatial: Geospatial Data and Analytics"],["map","key","\/Industry-Solutions","value","Geospatial Analysis Software Solutions | Harris Geospatial"],["map","key","\/Industry-Solutions\/Academic","value","Academic Software - ENVI \u0026 IDL Student Licenses | Harris Geospatial"],["map","key","\/Industry-Solutions\/Defense-Intelligence","value","Defense Intelligence Geospatial Software - Defense Imagery"],["map","key","\/Industry-Solutions\/Fed-Civil","value","Dense Point Cloud Mapping - Disaster Response Software"],["map","key","\/Industry-Solutions\/Maritime","value","AIS Marine Traffic \u0026 Vessel Tracking - Maritime Solutions \u0026 Technology"],["map","key","\/Industry-Solutions\/Precision-Agriculture","value","Precision Agriculture Technology \u0026 Software – Satellite Crop Monitoring"],["map","key","\/Industry-Solutions\/Utilities","value","Utility Assest \u0026 Data Management Services \u0026 Solutions"],["map","key","\/Industry-Solutions\/Solutions-Delivery","value","Enterprise Solutions Delivery - Integrated Project Management"],["map","key","\/Industry-Solutions\/Transportation","value","Transportation IT Solutions - Transportation \u0026 Weather Analytics"],["map","key","\/Software-Technology","value","Geospatial Products \u0026 Software Solutions | Harris Geospatial"],["map","key","\/Software-Technology\/Deep-Learning","value","Geospatial Machine Learning - Deep Learning Techology Solutions"],["map","key","\/Software-Technology\/ENVI-SARscape","value","ENVI SARscape - SAR Data Analysis, Processing \u0026 Tools"],["map","key","\/Software-Technology\/Helios","value","Geospatial Weather Radar Maps, Software \u0026 Technology | Helios"],["map","key","\/Software-Technology\/IDL","value","IDL Software - Interactive Data Visualization Solutions"],["map","key","\/Software-Technology\/Jagwire","value","Web-Based Geospatial Data Management Software - Jagwire"],["map","key","\/Software-Technology\/PrecisionPass","value","Drone Data Analytics - Drone \u0026 UAV Mapping Software | PrecisionPass"],["map","key","\/Software-Technology\/Geospatial-Services-Framework","value","Geospatial Services Framework - GeoAnalytics Framework \u0026 CMS"],["map","key","\/Data-Imagery","value","Geospatial Data \u0026 Imagery - Spatial Data Analysis"],["map","key","\/Data-Imagery\/Aerial-Imagery","value","Aerial Imagery \u0026 Photography - Hexagon Imagery Program"],["map","key","\/Data-Imagery\/Geiger-mode-LiDAR","value","Geiger-mode LiDAR - High Resolution LiDAR Data \u0026 Products"],["map","key","\/Data-Imagery\/Mapping-Services","value","Custom Geospatial Mapping Services - Satellite \u0026 Topographic Maps"],["map","key","\/Data-Imagery\/Visual-Simulation","value","Visual Simulation - Visual Information \u0026  3D Urban Model Software"],["map","key","\/Data-Imagery\/Elevation-Data","value","Digital Elevation Models \u0026 Maps - DEM Software - Digital Elevation Data"],["map","key","\/Data-Imagery\/Satellite-Imagery","value","Satellite Imagery Providers - Commercial Satellite Imagery"],["map","key","\/Company\/Events\/Tradeshows\/SAR-Analytics-Symposium","value","Synthetic Aperture Radar (SAR) Analytics Symposium - Oct 9-10, 2019"],["map","key","\/eas\/","value","ENVI Analytics Symposium - Aug 13-15, 2019 - Denver, CO"],["map","key","\/Data-Imagery\/Services\/Aerial-Survey-Mapping-Services","value","Aerial Mapping Services - Aerial Survey Solutions | L3 Harris Geospatial"],["map","key","\/Software-Technology\/ENVI-Deep-Learning","value","Automate Analytics with Deep Learning Technology - ENVI Deep Learning"],["map","key","\/Software-Technology\/ENVI-SARscape","value","SAR Data Processing Software – ENVI SARscape"]]
    },{
      "function":"__u",
      "vtp_stripWww":true,
      "vtp_component":"HOST",
      ...
      "function":"__c",
      "vtp_value":["template","www.",["macro",12]]
    },{
      "function":"__u",
      "vtp_component":"PROTOCOL",
      "vtp_enableMultiQueryKeys":false,
      ...
      "function":"__c",
      "vtp_value":["template","https:\/\/",["macro",12],["macro",7]]
    },{
      "function":"__c",
      "vtp_value":["template","https:\/\/",["macro",13],["macro",7]]
    },{
      "function":"__c",
      "vtp_value":["template",["macro",14],":\/\/",["macro",12],["macro",7]]
    },{
      "function":"__c",
      "vtp_value":["template",["macro",14],":\/\/",["macro",13],["macro",7]]
    },{
      "function":"__smm",
      "vtp_setDefaultValue":false,
      "vtp_input":["macro",7],
      "vtp_map":["list",["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution\/WorldView-4","value","WorldView-4 Satellite - High Definition Satellite Images"],["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution\/WorldView-3","value","WorldView-3 Satellite Imagery - WorldView 3 Resolution"],["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution\/WorldView-2","value","WorldView-2 Satellite Imagery - WorldView 2 Resolution"],["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution\/WorldView-1","value","WorldView-1 Satellite - High Quality Satellite Images"],["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution\/GeoEye","value","GeoEye Satellite - Digitalglobe GeoEye"],["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution\/KompSAT","value","KompSAT Satellite - KompSAT 2 \u0026 3 Resolution"],["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution\/Pleiades","value","Pleiades-1 - High Res Satellite Images"],["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution\/TerraSARX","value","TerraSAR X - High Resolution Satellite Imagery"],["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution\/SkySat","value","SkySat Satellite - Planet SkySat"],["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution\/TripleSat","value","TripleSat Satellite - High Resolution Satellite"],["map","key","\/Data-Imagery\/Satellite-Imagery\/Medium-Resolution\/SPOT-67","value","Spot 6 \u0026 7 Satellite - Satellite Image Resolution"],["map","key","\/Data-Imagery\/Satellite-Imagery\/Medium-Resolution\/RapidEye","value","RapidEye Satellite Imagery - Medium Resolution Satellite Imagery"],["map","key","\/Data-Imagery\/Satellite-Imagery\/Medium-Resolution\/PlanetScope","value","PlanetScope Satellite Imagery - PlanetScope Resolution"],["map","key","\/Software-Technology\/TerraColor-NextGen","value","Low Resolution Satellite Imagery - Global Satellite Images"],["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution\/Ikonos","value","Ikonos - Commercial Satellite Imagery"],["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution\/QuickBird","value","QuickBird Sateliite - Earth Observation Satellites"],["map","key","\/Data-Imagery\/Satellite-Imagery\/DigitalGlobe","value","DigitalGlobe - DigitalGlobe Satelite Imagery - High-Res Satellite Images"]]
    },{
      "function":"__smm",
      "vtp_setDefaultValue":false,
      "vtp_input":["macro",7],
      "vtp_map":["list",["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution\/WorldView-4","value","WorldView-4 Satellite delivers the highest level of detail available commercially. This highly accurate sensor produces top-quality imagery. Visit Harris today."],["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution\/WorldView-3","value","WorldView-3 is a versatile satellite capable of capturing 29 multispectral bands. This sensor is a great option for different types of uses. Explore our satellites today."],["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution\/WorldView-2","value","WorldView-2 Satellite imagery provides costal, yellow, red edge, and near-infrared band. It is capable of collecting up to 975,000 km a day. Visit Harris today."],["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution\/WorldView-1","value","WorldView-1 Satellite only captures panchromatic imagery. This sensor produces high quality satellite images that are great for historical areal views. Visit Harris today."],["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution\/GeoEye","value","GeoEye Satellite captures panchromatic and 4 multispectral bands. This sensor is great for historical and stereo imagery. Explore our satellites today!"],["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution\/KompSAT","value","KompSAT Satellite captures panchromatic and 5 multispectral bands. This sensor collects high resolution images good for historical data. Visit Harris today."],["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution\/Pleiades","value","The Pleiades-1 sensor is an ideal choice for new imagery collection of an area. It produces high res satellite images great for site monitoring or detection analysis."],["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution\/TerraSARX","value","TerraSAR-X is a detailed high-resolution satellite. It is ideal for any form of physical change detection and commercial use. Explore our satellites today."],["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution\/SkySat","value","The Planet SkySat Satellite monitors small and quickly changing areas with near-infrared and video capabilities. It is one of the fastest commercial sensors."],["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution\/TripleSat","value","TripleSat offers three satellite sensors located evenly around the world providing high resolution imagery and frequent updates. Explore Harris today."],["map","key","\/Data-Imagery\/Satellite-Imagery\/Medium-Resolution\/SPOT-67","value","Spot 6 and 7 Satellites are great options for needing imagery for larger area sizes and change detection. Explore the satellites Harris provides today."],["map","key","\/Data-Imagery\/Satellite-Imagery\/Medium-Resolution\/RapidEye","value","RapidEye is a constellation of 5 identical sensors and captures 5 different multispectral bands. This medium resolution satellite imagery is great for agricultural mapping."],["map","key","\/Data-Imagery\/Satellite-Imagery\/Medium-Resolution\/PlanetScope","value","PlanetScope Satellite Imagery makes up the largest commercial fleet of satellites. This mass amount of data is great to track agricultural change detection."],["map","key","\/Software-Technology\/TerraColor-NextGen","value","Explore TerraColor NextGen, a low-resolution satellite that produces larger global satellite images great for analyzing changes in landscapes and environments."],["map","key","\/Data-Imagery\/Satellite-Imagery\/DigitalGlobe","value","DigitalGlobe’s cutting-edge, high-resolution satellites carve out incredibly rendered images to help you extract insights \u0026 plan critical decisions. Visit Harris Geospatial today to learn more."],["map","key","\/Software-Technology\/ENVI-Deep-Learning","value","Our ENVI Deep Learning technology was specifically designed to work with remotely sensed satellite imagery to solve geospatial problems."],["map","key","\/Software-Technology\/ENVI-SARscape","value","Our ENVI SARscape allows you to easily process \u0026 analyze SAR data acquired from all existing spaceborne \u0026 selected airborne platforms."]]
    },{
      "function":"__v",
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
      ...
      "vtp_setDefaultValue":false,
      "vtp_input":["macro",7],
      "vtp_map":["list",["map","key","\/Industry-Solutions\/Academic","value","\u003Cscript type=\"application\/ld+json\"\u003E {   \"@context\": \"http:\/\/schema.org\/\",   \"@type\": \"Service\",   \"additionalType\": [ \"http:\/\/www.productontology.org\/doc\/Satellite_imagery\",   \"http:\/\/www.productontology.org\/doc\/Harris_Geospatial\",   \"http:\/\/www.productontology.org\/doc\/L3Harris_Technologies\"],   \"serviceType\": \"Academic ENVI and IDL Software\",   \"provider\": {      \"@type\": \"Organization\",     \"telephone\": \"+1-303-786-9900\",     \"url\": \"https:\/\/www.harrisgeospatial.com\/Industry-Solutions\/Academic\",     \"name\": \"L3Harris Geospatial Solutions\"   },   \"areaServed\": {     \"@type\": \"Country\",     \"name\": \"USA\"   },   \"description\": \"Top educators at learning institutions across North America use ENVI image analysis software as well as our scientific programming language IDL for cutting-edge research and to prepare students for careers in commercial, government, and defense organizations.\" } \u003C\/script\u003E"],["map","key","\/Industry-Solutions\/Defense-Intelligence","value","\u003Cscript type=\"application\/ld+json\"\u003E {   \"@context\": \"http:\/\/schema.org\/\",   \"@type\": \"Service\",   \"additionalType\": [ \"http:\/\/www.productontology.org\/doc\/Satellite_imagery\",   \"http:\/\/www.productontology.org\/doc\/Harris_Geospatial\",   \"http:\/\/www.productontology.org\/doc\/L3Harris_Technologies\",   \"http:\/\/www.productontology.org\/doc\/Military_intelligence\" ],   \"serviceType\": \"Defense Intelligence Geospatial Software\",   \"provider\": {      \"@type\": \"Organization\",     \"telephone\": \"+1-303-786-9900\",     \"url\": \"https:\/\/www.harrisgeospatial.com\/Industry-Solutions\/Defense-Intelligence\",     \"name\": \"L3Harris Geospatial Solutions\"   },   \"areaServed\": {     \"@type\": \"Country\",     \"name\": \"USA\"   },   \"description\": \"L3Harris Geospatial has supported the Defense and Intelligence community for decades with mission-proven technology and solutions. Our employees and tools are embedded across the ISR community at the national, operational, and tactical levels, providing cutting-edge support to critical missions for the Army, Air Force, Marine Corp, and intelligence agencies. \" } \u003C\/script\u003E"],["map","key","\/Industry-Solutions\/Fed-Civil","value","\u003Cscript type=\"application\/ld+json\"\u003E {   \"@context\": \"http:\/\/schema.org\/\",   \"@type\": \"Service\",   \"additionalType\": [ \"http:\/\/www.productontology.org\/doc\/Satellite_imagery\",   \"http:\/\/www.productontology.org\/doc\/Harris_Geospatial\",   \"http:\/\/www.productontology.org\/doc\/L3Harris_Technologies\"],   \"serviceType\": \"Federal \u0026 Civil Geospatial Solutions\",   \"provider\": {      \"@type\": \"Organization\",     \"telephone\": \"+1-303-786-9900\",     \"url\": \"https:\/\/www.harrisgeospatial.com\/Industry-Solutions\/Fed-Civil\",     \"name\": \"L3Harris Geospatial Solutions\"   },   \"areaServed\": {     \"@type\": \"Country\",     \"name\": \"USA\"   },   \"description\": \"Whether you want to extract buildings footprints, model flood plains, or provide actionable intelligence to first responders, we can provide a solution that meets your needs. We offer high-quality data and proven analytics that enable communities to prepare and respond to natural disasters as well as plan and monitor infrastructure.\"} \u003C\/script\u003E"],["map","key","\/Industry-Solutions\/Maritime","value","\u003Cscript type=\"application\/ld+json\"\u003E {   \"@context\": \"http:\/\/schema.org\/\",   \"@type\": \"Service\",   \"additionalType\": [ \"http:\/\/www.productontology.org\/doc\/Satellite_imagery\",   \"http:\/\/www.productontology.org\/doc\/Harris_Geospatial\",   \"http:\/\/www.productontology.org\/doc\/L3Harris_Technologies\",   \"http:\/\/www.productontology.org\/doc\/Automatic_identification_system\"],   \"serviceType\": \"Maritime Solutions \u0026 Technology\",   \"provider\": {      \"@type\": \"Organization\",     \"telephone\": \"+1-303-786-9900\",     \"url\": \"https:\/\/www.harrisgeospatial.com\/Industry-Solutions\/Maritime\",     \"name\": \"L3Harris Geospatial Solutions\"   },   \"areaServed\": {     \"@type\": \"Country\",     \"name\": \"USA\"   },   \"description\": \"L3Harris has partnered with exactEarth Ltd to offer a full range of Satellite Automatic Identification System (S-AIS) data services and products to provide the most timely and accurate information available to run any maritime operation safer and more efficiently than ever before. This partnership is transforming the industry with real-time advanced ship tracking solutions that optimize L3Harris' global satellite constellation for AIS.\"}   \u003C\/script\u003E"],["map","key","\/Industry-Solutions\/Utilities","value","\u003Cscript type=\"application\/ld+json\"\u003E {   \"@context\": \"http:\/\/schema.org\/\",   \"@type\": \"Service\",   \"additionalType\": [ \"http:\/\/www.productontology.org\/doc\/Satellite_imagery\",   \"http:\/\/www.productontology.org\/doc\/Harris_Geospatial\",   \"http:\/\/www.productontology.org\/doc\/L3Harris_Technologies\",   \"http:\/\/www.productontology.org\/doc\/Utility_software\"],   \"serviceType\": \"Utility Asset Management Solutions\",   \"provider\": {      \"@type\": \"Organization\",     \"telephone\": \"+1-303-786-9900\",     \"url\": \"https:\/\/www.harrisgeospatial.com\/Industry-Solutions\/Utilities\",     \"name\": \"L3Harris Geospatial Solutions\"   },   \"areaServed\": {     \"@type\": \"Country\",     \"name\": \"USA\"   },   \"description\": \"L3Harris Geospatial's utility management solutions help you better inventory, inspect \u0026 maintain utility networks. Whether it's managing vegetation encroachment, monitoring utility assets, or responding to a weather event, remotely sensed data can provide critical insights faster, and more affordably than traditional visual inspections.\"   }   \u003C\/script\u003E"],["map","key","\/Industry-Solutions\/Solutions-Delivery","value","\u003Cscript type=\"application\/ld+json\"\u003E {   \"@context\": \"http:\/\/schema.org\/\",   \"@type\": \"Service\",   \"additionalType\": [ \"http:\/\/www.productontology.org\/doc\/Satellite_imagery\",   \"http:\/\/www.productontology.org\/doc\/Harris_Geospatial\",   \"http:\/\/www.productontology.org\/doc\/L3Harris_Technologies\",   \"http:\/\/www.productontology.org\/doc\/Geospatial_metadata\"],   \"serviceType\": \"Solutions Delivery - Geospatial Project Management\",   \"provider\": {      \"@type\": \"Organization\",     \"telephone\": \"+1-303-786-9900\",     \"url\": \"https:\/\/www.harrisgeospatial.com\/Industry-Solutions\/Solutions-Delivery\",     \"name\": \"L3Harris Geospatial Solutions\"   },   \"areaServed\": {     \"@type\": \"Country\",     \"name\": \"USA\"   },   \"description\": \"Our Solutions Delivery group works with organizations around the world to accelerate geospatial innovations to solve some of the most challenging problems we face. Over 30 years of domain expertise in remote sensing, image analytics and software development has been refined within our team to help clients unlock the power of data and imagery to transform their businesses and change their industries.\"   }   \u003C\/script\u003E"],["map","key","\/Industry-Solutions\/Transportation","value","\u003Cscript type=\"application\/ld+json\"\u003E {   \"@context\": \"http:\/\/schema.org\/\",   \"@type\": \"Service\",   \"additionalType\": [ \"http:\/\/www.productontology.org\/doc\/Satellite_imagery\",   \"http:\/\/www.productontology.org\/doc\/Harris_Geospatial\",   \"http:\/\/www.productontology.org\/doc\/L3Harris_Technologies\",   \"http:\/\/www.productontology.org\/doc\/Network_management_software\"],   \"serviceType\": \"Transportation Technology\",   \"provider\": {      \"@type\": \"Organization\",     \"telephone\": \"+1-303-786-9900\",     \"url\": \"https:\/\/www.harrisgeospatial.com\/Industry-Solutions\/Transportation\",     \"name\": \"L3Harris Geospatial Solutions\"   },   \"areaServed\": {     \"@type\": \"Country\",     \"name\": \"USA\"   },   \"description\": \"Managing transportation networks, whether road, rail, or aviation, is a high-risk proposition. Keeping travelers safe, as well as your crew, is of the upmost importance. But the challenges of managing a network aren’t limited to safety, they also include controlling costs, ensuring reliability and boosting efficiencies. As companies look for ways to improve on all aspects of transportation infrastructure management, remote sensing technology such as satellite, UAS, and LiDAR data combined with big data analytics is being looked at to improve safety, reduce expenses, and make better decisions.\"   }   \u003C\/script\u003E"],["map","key","\/Industry-Solutions\/Precision-Agriculture","value","\u003Cscript type=\"application\/ld+json\"\u003E {   \"@context\": \"http:\/\/schema.org\/\",   \"@type\": \"Service\",   \"additionalType\": [ \"http:\/\/www.productontology.org\/doc\/Satellite_imagery\",   \"http:\/\/www.productontology.org\/doc\/Harris_Geospatial\",   \"http:\/\/www.productontology.org\/doc\/L3Harris_Technologies\",   \"http:\/\/www.productontology.org\/doc\/Agricultural_science\",   \"http:\/\/www.productontology.org\/doc\/Precision_agriculture\"],   \"serviceType\": \"Precision Agriculture Technology\",   \"provider\": {      \"@type\": \"Organization\",     \"telephone\": \"+1-303-786-9900\",     \"url\": \"https:\/\/www.harrisgeospatial.com\/Industry-Solutions\/Precision-Agriculture\",     \"name\": \"L3Harris Geospatial Solutions\"   },   \"areaServed\": {     \"@type\": \"Country\",     \"name\": \"USA\"   },   \"description\": \"Too often in agriculture, a one-size-fits-all approach of applying uniform amounts of water, fertilizers, and pesticides is standard procedure even though it isn’t reliably effective. Now Ag businesses can tailor crop management decisions by using modern precision agriculture techniques – scientifically proven approaches that analyze remotely sensed data such as satellite and UAV imagery. Whether it’s data or analytics, L3Harris Geospatial is your source to maximize yields and boost profits.\"   }   \u003C\/script\u003E"]]
    },{
      "function":"__smm",
      "vtp_setDefaultValue":false,
      "vtp_input":["macro",7],
      "vtp_map":["list",["map","key","\/Data-Imagery\/Satellite-Imagery","value","{   \"@context\": \"http:\/\/www.schema.org\",   \"@type\": \"service\",   \"brand\": \"L3Harris Geospatial\",   \"url\": \"https:\/\/www.harrisgeospatial.com\/Data-Imagery\/Satellite-Imagery\",   \"name\": \"Satellite Imagery Providers\",   \"image\": \"https:\/\/www.harrisgeospatial.com\/Portals\/0\/L3Harris_GEO.png?ver=2019-09-27-100745-350\",   \"description\": \"L3Harris Geospatial has partnered with the leading satellite imagery providers including Airbus, DigitalGlobe, and Planet to offer advanced satellite imagery data for any location in the world. \" }   \tvar script = document.createElement('script'); \tscript.type = \"application\/ld+json\"; \tscript.innerHTML = JSON.stringify(data); \tdocument.getElementsByTagName('head')[0].appendChild(script);     })(document);  \u003C\/script\u003E"],["map","key","\/Data-Imagery\/Satellite-Imagery\/High-Resolution","value","{   \"@context\": \"http:\/\/www.schema.org\",   \"@type\": \"service\",   \"brand\": \"L3Harris Geospatial\",   \"name\": \"High Resolution Satellite Imagery\",   \"url\": \"https:\/\/www.harrisgeospatial.com\/Data-Imagery\/Satellite-Imagery\/High-Resolution\",   \"image\": \"https:\/\/www.harrisgeospatial.com\/Portals\/0\/L3Harris_GEO.png?ver=2019-09-27-100745-350\",   \"description\": \"  L3Harris Geospatial offers an extensive selection of the highest resolution satellite imagery commercially available. Our vast archive includes imagery from all leading providers, such as DigitalGlobe, Airbus, and Satrec Imaging. \"}    \tvar script = document.createElement('script'); \tscript.type = \"application\/ld+json\"; \tscript.innerHTML = JSON.stringify(data); \tdocument.getElementsByTagName('head')[0].appendChild(script);     })(document);  \u003C\/script\u003E"],["map","key","\/Data-Imagery\/Satellite-Imagery\/Medium-Resolution","value","{   \"@context\": \"http:\/\/www.schema.org\",   \"@type\": \"service\",   \"brand\": \"L3Harris Geospatial\",   \"name\": \"Low Resolution Satellite Imagery\",   \"url\": \"https:\/\/www.harrisgeospatial.com\/Data-Imagery\/Satellite-Imagery\/Medium-Resolution\",   \"image\": \"https:\/\/www.harrisgeospatial.com\/Portals\/0\/L3Harris_GEO.png?ver=2019-09-27-100745-350\",   \"description\": \"L3Harris Geospatial’s archive of lower resolution satellite imagery is a great option for those needing imagery of large areas, such as states, provinces or entire countries.\"}    \tvar script = document.createElement('script'); \tscript.type = \"application\/ld+json\"; \tscript.innerHTML = JSON.stringify(data); \tdocument.getElementsByTagName('head')[0].appendChild(script);     })(document);  \u003C\/script\u003E"],["map","key","\/Data-Imagery\/Elevation-Data","value","{   \"@context\": \"http:\/\/www.schema.org\",   \"@type\": \"service\",   \"brand\": \"L3Harris Geospatial\",   \"name\": \"Elevation Data\",   \"url\": \"https:\/\/www.harrisgeospatial.com\/Data-Imagery\/Elevation-Data\",   \"image\": \"https:\/\/www.harrisgeospatial.com\/Portals\/0\/L3Harris_GEO.png?ver=2019-09-27-100745-350\",   \"description\": \"L3Harris Geospatial offers a wide variety of in-house digital elevation datasets and has partnered with other leading topography providers such as Airbus and PlanetObserver to provide multi-resolution Digital Elevation Models (DEM) coverage of Earth. \"}    \tvar script = document.createElement('script'); \tscript.type = \"application\/ld+json\"; \tscript.innerHTML = JSON.stringify(data); \tdocument.getElementsByTagName('head')[0].appendChild(script);     })(document);  \u003C\/script\u003E"],["map","key","\/Data-Imagery\/Aerial-Imagery","value","{   \"@context\": \"http:\/\/www.schema.org\",   \"@type\": \"service\",   \"brand\": \"L3Harris Geospatial\",   \"name\": \"Aerial Imagery\",   \"url\": \"https:\/\/www.harrisgeospatial.com\/Data-Imagery\/Aerial-Imagery\",   \"image\": \"https:\/\/www.harrisgeospatial.com\/Portals\/0\/L3Harris_GEO.png?ver=2019-09-27-100745-350\",   \"description\": \"Access the best commercially available aerial photography that provides a higher level of detail than satellite images, almost complete absence of clouds, and is very cost effective in many cases. Aerial maps from L3Harris Geospatial are regularly updated, with access to historical imagery as well, making it perfect for individuals, small businesses, farms, construction, real estate, and more. \"}    \tvar script = document.createElement('script'); \tscript.type = \"application\/ld+json\"; \tscript.innerHTML = JSON.stringify(data); \tdocument.getElementsByTagName('head')[0].appendChild(script);     })(document);  \u003C\/script\u003E"],["map","key","\/Data-Imagery\/Services\/Aerial-Survey-Mapping-Services","value","{   \"@context\": \"http:\/\/www.schema.org\",   \"@type\": \"service\",   \"brand\": \"L3Harris Geospatial\",   \"name\": \"Aerial Survey Mapping Services\",   \"url\": \"https:\/\/www.harrisgeospatial.com\/Data-Imagery\/Services\/Aerial-Survey-Mapping-Services\",   \"image\": \"https:\/\/www.harrisgeospatial.com\/Portals\/0\/L3Harris_GEO.png?ver=2019-09-27-100745-350\",   \"description\": \"L3Harris Geospatial offers fully integrated aerial digital topographic mapping services with the ability to take on any project on the North American Continent.\"}   \tvar script = document.createElement('script'); \tscript.type = \"application\/ld+json\"; \tscript.innerHTML = JSON.stringify(data); \tdocument.getElementsByTagName('head')[0].appendChild(script);     })(document); \u003C\/script\u003E"],["map","key","\/Data-Imagery\/Services\/Satellite-Imagery-Services","value","{   \"@context\": \"http:\/\/www.schema.org\",   \"@type\": \"service\",   \"brand\": \"L3Harris Geospatial\",   \"name\": \"Satellite Imagery Services\",   \"url\": \"https:\/\/www.harrisgeospatial.com\/Data-Imagery\/Services\/Satellite-Imagery-Services\",   \"image\": \"https:\/\/www.harrisgeospatial.com\/Portals\/0\/L3Harris_GEO.png?ver=2019-09-27-100745-350\",   \"description\": \"L3Harris Geospatial provides a wide range of high-quality professional and custom satellite mapping services, with end-to-end capability from data acquisition, to data processing, to data analysis.\"}    \tvar script = document.createElement('script'); \tscript.type = \"application\/ld+json\"; \tscript.innerHTML = JSON.stringify(data); \tdocument.getElementsByTagName('head')[0].appendChild(script);     })(document);  \u003C\/script\u003E"],["map","key","\/Data-Imagery\/Vector-Data-and-Beyond","value","{   \"@context\": \"http:\/\/www.schema.org\",   \"@type\": \"service\",   \"brand\": \"L3Harris Geospatial\",   \"name\": \"Vector Data\",   \"url\": \"https:\/\/www.harrisgeospatial.com\/Data-Imagery\/Vector-Data-and-Beyond\",   \"image\": \"https:\/\/www.harrisgeospatial.com\/Portals\/0\/L3Harris_GEO.png?ver=2019-09-27-100745-350\",   \"description\": \"A large variety of digital vector maps are available that include vector line, polygon, and point data sets for all areas of the world. These include U.S. Land Use \/ Land Clutter data, Garmin Digital Vector Maps, AW3D Data Sets, major world linear and point features, and Energy Data Sets as well as access to detailed international city mapping.\"}    \tvar script = document.createElement('script'); \tscript.type = \"application\/ld+json\"; \tscript.innerHTML = JSON.stringify(data); \tdocument.getElementsByTagName('head')[0].appendChild(script);     })(document);  \u003C\/script\u003E"]]
    },{
      "function":"__u",
      "vtp_component":"HOST",
      "vtp_enableMultiQueryKeys":false,
  ...
  "tags":[{
      ...
      "vtp_linkerDomains":"https:\/\/intelliearth.harrisgeospatial.com\/",
      ...
      "vtp_uniqueTriggerId":"9125619_34",
      "tag_id":98
    },{
      "function":"__lcl",
      "vtp_waitForTags":false,
      "vtp_checkValidation":false,
      "vtp_waitForTagsTimeout":"2000",
      "vtp_uniqueTriggerId":"9125619_48",
      "tag_id":99
    },{
      "function":"__cl",
      "tag_id":100
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\u003Clink rel=\"canonical\" href=\"https:\/\/www.harrisgeospatial.com\"\u003E",
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\n\u003Cscript async data-gtmsrc=\"https:\/\/www.googletagmanager.com\/gtag\/js?id=AW-963837797\" type=\"text\/gtmscript\"\u003E\u003C\/script\u003E\n\u003Cscript type=\"text\/gtmscript\"\u003Ewindow.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments)}gtag(\"js\",new Date);gtag(\"config\",\"AW-963837797\");\u003C\/script\u003E\n\u003Cscript type=\"text\/gtmscript\"\u003Egtag(\"config\",\"AW-963837797\/mU_GCIW1rZIBEOX-y8sD\",{phone_conversion_number:\"+1 (303) 786-9900\"});\u003C\/script\u003E\n\n",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":12
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\n\u003Cscript async data-gtmsrc=\"https:\/\/www.googletagmanager.com\/gtag\/js?id=AW-851424079\" type=\"text\/gtmscript\"\u003E\u003C\/script\u003E\n\u003Cscript type=\"text\/gtmscript\"\u003Ewindow.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments)}gtag(\"js\",new Date);gtag(\"config\",\"AW-851424079\");\u003C\/script\u003E\n\u003Cscript type=\"text\/gtmscript\"\u003Egtag(\"config\",\"AW-851424079\/uN91CL64rZIBEM_m_pUD\",{phone_conversion_number:\"1-866-499-6277\"});\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":13
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"application\/ld+json\"\u003E\n{\n  \"@context\": \"https:\/\/schema.org\",\n  \"@type\": \"Event\",\n  \"name\": \"ENVI Analytics Symposium\",\n  \"description\": \"Hear from geospatial industry experts about successful real-world analytical applications, all while sitting in the beautiful surroundings of The Ritz-Carlton, Denver.\",\n  \"image\": \"https:\/\/www.harrisgeospatial.com\/Portals\/0\/Images\/EAS\/EAS-300x250.jpg\",\n  \"startDate\": \"2019-08-13T09:00\",\n  \"endDate\": \"2019-08-15T17:00\",\n  \"location\": {\n    \"@type\": \"Place\",\n    \"name\": \"RITZ-CARLTON, DENVER\",\n    \"address\": {\n      \"@type\": \"PostalAddress\",\n      \"streetAddress\": \"1881 Curtis Street\",\n      \"addressLocality\": \"Denver\",\n      \"addressRegion\": \"CO\",\n      \"postalCode\": \"80202\",\n      \"addressCountry\": \"US\"\n    }\n  },\n  \"offers\": [{\n    \"@type\": \"Offer\",\n    \"name\": \"Early Bird Conference Pass\",\n    \"price\": \"395.00\",\n    \"priceCurrency\": \"USD\",\n    \"validFrom\": \"2019-05-01\",\n    \"url\": \"https:\/\/www.harrisgeospatial.com\/Company\/Events\/Tradeshows\/EAS#register\",\n    \"availability\": \"https:\/\/schema.org\/InStock\"\n  },{\n    \"@type\": \"Offer\",\n    \"name\": \"Early Bird All Access Pass\",\n    \"price\": \"545.00\",\n    \"priceCurrency\": \"USD\",\n    \"validFrom\": \"2019-05-01\",\n    \"url\": \"https:\/\/www.harrisgeospatial.com\/Company\/Events\/Tradeshows\/EAS#register\",\n    \"availability\": \"https:\/\/schema.org\/InStock\"\n  }]\n}\n\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":19
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"application\/ld+json\"\u003E\n { \"@context\": \"https:\/\/schema.org\",\n \"@type\": \"Organization\",\n \"name\": \"L3Harris Geospatial\",\n \"legalName\" : \"L3Harris Geospatial\",\n \"url\": \"https:\/\/www.harrisgeospatial.com\/\",\n \"logo\": \"https:\/\/www.harrisgeospatial.com\/Portals\/0\/L3Harris_GEO.png?ver=2019-09-27-100745-350\",\n \"foundingDate\": \"1977\",\n \"address\": {\n \"@type\": \"PostalAddress\",\n \"streetAddress\": \"385 Interlocken Crescent, Suite 300\",\n \"addressLocality\": \"Broomfield\",\n \"addressRegion\": \"CO\",\n \"postalCode\": \"80021\",\n \"addressCountry\": \"USA\"\n },\n \"contactPoint\": {\n \"@type\": \"ContactPoint\",\n \"additionalType\": \"Software \u0026 Technology Sales\",\n \"contactType\": \"sales\",\n \"telephone\": \"[+1 (303) 786-9900]\",\n \"email\": \"geospatialinfo@L3Harris.com\"\n },\n \"sameAs\": [ \n\"https:\/\/www.linkedin.com\/company\/harrisgeospatialsolutions\/\",\n\"https:\/\/www.facebook.com\/HarrisGeospatialSolutions\/\",\n\"https:\/\/twitter.com\/geobyharris\",\n\"https:\/\/www.youtube.com\/channel\/UCkzRf1fcN88dP73DLNYIwLg\",\n\"https:\/\/en.wikipedia.org\/wiki\/Harris_Geospatial\"\n ]}\n var script = document.createElement('script');\nscript.type = \"application\/ld+json\";\nscript.innerHTML = JSON.stringify(data);\ndocument.getElementsByTagName('head')[0].appendChild(script);\n})(document);\n\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":26
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"application\/ld+json\"\u003E\n{\n  \"@context\": \"http:\/\/schema.org\/\",\n  \"@type\": \"Service\",\n  \"additionalType\": [ \"http:\/\/www.productontology.org\/doc\/Satellite_imagery\",\n  \"http:\/\/www.productontology.org\/doc\/Harris_Geospatial\",\n  \"http:\/\/www.productontology.org\/doc\/L3Harris_Technologies\"],\n  \"serviceType\": \"Academic ENVI and IDL Software\",\n  \"provider\": { \n    \"@type\": \"Organization\",\n    \"telephone\": \"+1-303-786-9900\",\n    \"url\": \"https:\/\/www.harrisgeospatial.com\/Industry-Solutions\/Academic\",\n    \"name\": \"L3Harris Geospatial Solutions\"\n  },\n  \"areaServed\": {\n    \"@type\": \"Country\",\n    \"name\": \"USA\"\n  },\n  \"description\": \"Top educators at learning institutions across North America use ENVI image analysis software as well as our scientific programming language IDL for cutting-edge research and to prepare students for careers in commercial, government, and defense organizations.\"\n}\n\tvar script = document.createElement('script');\n\tscript.type = \"application\/ld+json\";\n\tscript.innerHTML = JSON.stringify(data);\n\tdocument.getElementsByTagName('head')[0].appendChild(script);\n    })(document);\n\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":28
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"application\/ld+json\"\u003E\n{\n  \"@context\": \"http:\/\/schema.org\/\",\n  \"@type\": \"Service\",\n  \"additionalType\": [ \"http:\/\/www.productontology.org\/doc\/Satellite_imagery\",\n  \"http:\/\/www.productontology.org\/doc\/Harris_Geospatial\",\n  \"http:\/\/www.productontology.org\/doc\/L3Harris_Technologies\",\n  \"http:\/\/www.productontology.org\/doc\/Military_intelligence\" ],\n  \"serviceType\": \"Defense Intelligence Geospatial Software\",\n  \"provider\": { \n    \"@type\": \"Organization\",\n    \"telephone\": \"+1-303-786-9900\",\n    \"url\": \"https:\/\/www.harrisgeospatial.com\/Industry-Solutions\/Defense-Intelligence\",\n    \"name\": \"L3Harris Geospatial Solutions\"\n  },\n  \"areaServed\": {\n    \"@type\": \"Country\",\n    \"name\": \"USA\"\n  },\n  \"description\": \"L3Harris Geospatial has supported the Defense and Intelligence community for decades with mission-proven technology and solutions. Our employees and tools are embedded across the ISR community at the national, operational, and tactical levels, providing cutting-edge support to critical missions for the Army, Air Force, Marine Corp, and intelligence agencies. \"\n}\n\tvar script = document.createElement('script');\n\tscript.type = \"application\/ld+json\";\n\tscript.innerHTML = JSON.stringify(data);\n\tdocument.getElementsByTagName('head')[0].appendChild(script);\n    })(document);\n\u003C\/script\u003E\n",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":29
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"application\/ld+json\"\u003E\n{\n  \"@context\": \"http:\/\/schema.org\/\",\n  \"@type\": \"Service\",\n  \"additionalType\": [ \"http:\/\/www.productontology.org\/doc\/Satellite_imagery\",\n  \"http:\/\/www.productontology.org\/doc\/Harris_Geospatial\",\n  \"http:\/\/www.productontology.org\/doc\/L3Harris_Technologies\"],\n  \"serviceType\": \"Federal \u0026 Civil Geospatial Solutions\",\n  \"provider\": { \n    \"@type\": \"Organization\",\n    \"telephone\": \"+1-303-786-9900\",\n    \"url\": \"https:\/\/www.harrisgeospatial.com\/Industry-Solutions\/Fed-Civil\",\n    \"name\": \"L3Harris Geospatial Solutions\"\n  },\n  \"areaServed\": {\n    \"@type\": \"Country\",\n    \"name\": \"USA\"\n  },\n  \"description\": \"Whether you want to extract buildings footprints, model flood plains, or provide actionable intelligence to first responders, we can provide a solution that meets your needs. We offer high-quality data and proven analytics that enable communities to prepare and respond to natural disasters as well as plan and monitor infrastructure.\"\n  }\n  \tvar script = document.createElement('script');\n\tscript.type = \"application\/ld+json\";\n\tscript.innerHTML = JSON.stringify(data);\n\tdocument.getElementsByTagName('head')[0].appendChild(script);\n    })(document);\n\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":30
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"application\/ld+json\"\u003E\n{\n  \"@context\": \"http:\/\/schema.org\/\",\n  \"@type\": \"Service\",\n  \"additionalType\": [ \"http:\/\/www.productontology.org\/doc\/Satellite_imagery\",\n  \"http:\/\/www.productontology.org\/doc\/Harris_Geospatial\",\n  \"http:\/\/www.productontology.org\/doc\/L3Harris_Technologies\",\n  \"http:\/\/www.productontology.org\/doc\/Automatic_identification_system\"],\n  \"serviceType\": \"Maritime Solutions \u0026 Technology\",\n  \"provider\": { \n    \"@type\": \"Organization\",\n    \"telephone\": \"+1-303-786-9900\",\n    \"url\": \"https:\/\/www.harrisgeospatial.com\/Industry-Solutions\/Maritime\",\n    \"name\": \"L3Harris Geospatial Solutions\"\n  },\n  \"areaServed\": {\n    \"@type\": \"Country\",\n    \"name\": \"USA\"\n  },\n  \"description\": \"L3Harris has partnered with exactEarth Ltd to offer a full range of Satellite Automatic Identification System (S-AIS) data services and products to provide the most timely and accurate information available to run any maritime operation safer and more efficiently than ever before. This partnership is transforming the industry with real-time advanced ship tracking solutions that optimize L3Harris' global satellite constellation for AIS.\"\n  }\n  \tvar script = document.createElement('script');\n\tscript.type = \"application\/ld+json\";\n\tscript.innerHTML = JSON.stringify(data);\n\tdocument.getElementsByTagName('head')[0].appendChild(script);\n    })(document);\n  \u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":31
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":" \u003Cscript type=\"application\/ld+json\"\u003E\n{\n  \"@context\": \"http:\/\/schema.org\/\",\n  \"@type\": \"Service\",\n  \"additionalType\": [ \"http:\/\/www.productontology.org\/doc\/Satellite_imagery\",\n  \"http:\/\/www.productontology.org\/doc\/Harris_Geospatial\",\n  \"http:\/\/www.productontology.org\/doc\/L3Harris_Technologies\",\n  \"http:\/\/www.productontology.org\/doc\/Utility_software\"],\n  \"serviceType\": \"Utility Asset Management Solutions\",\n  \"provider\": { \n    \"@type\": \"Organization\",\n    \"telephone\": \"+1-303-786-9900\",\n    \"url\": \"https:\/\/www.harrisgeospatial.com\/Industry-Solutions\/Utilities\",\n    \"name\": \"L3Harris Geospatial Solutions\"\n  },\n  \"areaServed\": {\n    \"@type\": \"Country\",\n    \"name\": \"USA\"\n  },\n  \"description\": \"L3Harris Geospatial's utility management solutions help you better inventory, inspect \u0026 maintain utility networks. Whether it's managing vegetation encroachment, monitoring utility assets, or responding to a weather event, remotely sensed data can provide critical insights faster, and more affordably than traditional visual inspections.\"\n  }\n  \tvar script = document.createElement('script');\n\tscript.type = \"application\/ld+json\";\n\tscript.innerHTML = JSON.stringify(data);\n\tdocument.getElementsByTagName('head')[0].appendChild(script);\n    })(document);\n  \u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":32
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"application\/ld+json\"\u003E\n{\n  \"@context\": \"http:\/\/schema.org\/\",\n  \"@type\": \"Service\",\n  \"additionalType\": [ \"http:\/\/www.productontology.org\/doc\/Satellite_imagery\",\n  \"http:\/\/www.productontology.org\/doc\/Harris_Geospatial\",\n  \"http:\/\/www.productontology.org\/doc\/L3Harris_Technologies\",\n  \"http:\/\/www.productontology.org\/doc\/Geospatial_metadata\"],\n  \"serviceType\": \"Solutions Delivery - Geospatial Project Management\",\n  \"provider\": { \n    \"@type\": \"Organization\",\n    \"telephone\": \"+1-303-786-9900\",\n    \"url\": \"https:\/\/www.harrisgeospatial.com\/Industry-Solutions\/Solutions-Delivery\",\n    \"name\": \"L3Harris Geospatial Solutions\"\n  },\n  \"areaServed\": {\n    \"@type\": \"Country\",\n    \"name\": \"USA\"\n  },\n  \"description\": \"Our Solutions Delivery group works with organizations around the world to accelerate geospatial innovations to solve some of the most challenging problems we face. Over 30 years of domain expertise in remote sensing, image analytics and software development has been refined within our team to help clients unlock the power of data and imagery to transform their businesses and change their industries.\"\n  }\n  \tvar script = document.createElement('script');\n\tscript.type = \"application\/ld+json\";\n\tscript.innerHTML = JSON.stringify(data);\n\tdocument.getElementsByTagName('head')[0].appendChild(script);\n    })(document);\n  \u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":33
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"script type=\u0026quot;application\/ld+json\u0026quot;\u0026gt;\n{\n  \u0026quot;@context\u0026quot;: \u0026quot;http:\/\/schema.org\/\u0026quot;,\n  \u0026quot;@type\u0026quot;: \u0026quot;Service\u0026quot;,\n  \u0026quot;additionalType\u0026quot;: [ \u0026quot;http:\/\/www.productontology.org\/doc\/Satellite_imagery\u0026quot;,\n  \u0026quot;http:\/\/www.productontology.org\/doc\/Harris_Geospatial\u0026quot;,\n  \u0026quot;http:\/\/www.productontology.org\/doc\/L3Harris_Technologies\u0026quot;,\n  \u0026quot;http:\/\/www.productontology.org\/doc\/Network_management_software\u0026quot;],\n  \u0026quot;serviceType\u0026quot;: \u0026quot;Transportation Technology\u0026quot;,\n  \u0026quot;provider\u0026quot;: { \n    \u0026quot;@type\u0026quot;: \u0026quot;Organization\u0026quot;,\n    \u0026quot;telephone\u0026quot;: \u0026quot;+1-303-786-9900\u0026quot;,\n    \u0026quot;url\u0026quot;: \u0026quot;https:\/\/www.harrisgeospatial.com\/Industry-Solutions\/Transportation\u0026quot;,\n    \u0026quot;name\u0026quot;: \u0026quot;L3Harris Geospatial Solutions\u0026quot;\n  },\n  \u0026quot;areaServed\u0026quot;: {\n    \u0026quot;@type\u0026quot;: \u0026quot;Country\u0026quot;,\n    \u0026quot;name\u0026quot;: \u0026quot;USA\u0026quot;\n  },\n  \u0026quot;description\u0026quot;: \u0026quot;Managing transportation networks, whether road, rail, or aviation, is a high-risk proposition. Keeping travelers safe, as well as your crew, is of the upmost importance. But the challenges of managing a network aren’t limited to safety, they also include controlling costs, ensuring reliability and boosting efficiencies. As companies look for ways to improve on all aspects of transportation infrastructure management, remote sensing technology such as satellite, UAS, and LiDAR data combined with big data analytics is being looked at to improve safety, reduce expenses, and make better decisions.\u0026quot;\n  }\n\tvar script = document.createElement(\u0026#39;script\u0026#39;);\n\tscript.type = \u0026quot;application\/ld+json\u0026quot;;\n\tscript.innerHTML = JSON.stringify(data);\n\tdocument.getElementsByTagName(\u0026#39;head\u0026#39;)[0].appendChild(script);\n    })(document);\n  \u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":34
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"application\/ld+json\"\u003E\n{\n  \"@context\": \"http:\/\/schema.org\/\",\n  \"@type\": \"Service\",\n  \"additionalType\": [ \"http:\/\/www.productontology.org\/doc\/Satellite_imagery\",\n  \"http:\/\/www.productontology.org\/doc\/Harris_Geospatial\",\n  \"http:\/\/www.productontology.org\/doc\/L3Harris_Technologies\",\n  \"http:\/\/www.productontology.org\/doc\/Agricultural_science\",\n  \"http:\/\/www.productontology.org\/doc\/Precision_agriculture\"],\n  \"serviceType\": \"Precision Agriculture Technology\",\n  \"provider\": { \n    \"@type\": \"Organization\",\n    \"telephone\": \"+1-303-786-9900\",\n    \"url\": \"https:\/\/www.harrisgeospatial.com\/Industry-Solutions\/Precision-Agriculture\",\n    \"name\": \"L3Harris Geospatial Solutions\"\n  },\n  \"areaServed\": {\n    \"@type\": \"Country\",\n    \"name\": \"USA\"\n  },\n  \"description\": \"Too often in agriculture, a one-size-fits-all approach of applying uniform amounts of water, fertilizers, and pesticides is standard procedure even though it isn’t reliably effective. Now Ag businesses can tailor crop management decisions by using modern precision agriculture techniques – scientifically proven approaches that analyze remotely sensed data such as satellite and UAV imagery. Whether it’s data or analytics, L3Harris Geospatial is your source to maximize yields and boost profits.\"\n  }\n  \tvar script = document.createElement('script');\n\tscript.type = \"application\/ld+json\";\n\tscript.innerHTML = JSON.stringify(data);\n\tdocument.getElementsByTagName('head')[0].appendChild(script);\n    })(document);\n  \u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":35
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"application\/ld+json\"\u003E\n{ \"@context\" : \"http:\/\/schema.org\",\n  \"@type\" : \"Organization\",\n    \"name\": \"L3Harris Geospatial\",\n    \"sameAs\": \"http:\/\/www.productontology.org\/doc\/L3Harris_Technologies\",\n    \"contactPoint\": [{\n    \"@type\": \"ContactPoint\",\n    \"telephone\": \"+1 (303) 786-9900\",\n    \"url\": \"https:\/\/www.harrisgeospatial.com\/Company\/Contact-Us\",\n    \"email\": \"geospatialinfo@L3Harris.com\",\n    \"contactType\": \"Software \u0026 Technology Sales\"}]}\n      \tvar script = document.createElement('script');\n\tscript.type = \"application\/ld+json\";\n\tscript.innerHTML = JSON.stringify(data);\n\tdocument.getElementsByTagName('head')[0].appendChild(script);\n    })(document);\n\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":36
  ...
  "predicates":[{
      ...
      "function":"_re",
      "arg0":["macro",4],
      "arg1":"(^Update your Software$)|(Contact Now)|(^Start Self-Paced Training$)|(^View Training Calendar and Registration$)|(Download)|(Download Data)|(Request a Quote)|(Contact Us)|(Student License Information)|(Buy Now)|(Sign Me Up)|(Send Email)|(How Can We Help)|(Download PDF)|(Contact Us Today)|(Contact Us to Learn More)",
      "ignore_case":true
    },{
      "function":"_eq",
      "arg0":["macro",0],
      ...
      "function":"_re",
      "arg0":["macro",6],
      "arg1":"\/Data-Imagery\/default2.html|\/Data-Imagery\/ContactForm.html|\/Data-Imagery\/Products\/SatelliteImagery\/EarthSat|\/Data-Imagery\/products\/gissoftware\/mapinfo|\/Data-Imagery\/Products\/AerialPhotography\/Sanborn|\/Data-Imagery\/Products\/SatelliteImagery\/WorldView1|\/Data-Imagery\/Products\/SatelliteImagery\/EarthSat|\/Company\/Events\/Tradeshows\/EAS"
    },{
      "function":"_cn",
      "arg0":["macro",7],
      "arg1":"\/docs\/"
      ...
      "function":"_cn",
      "arg0":["macro",7],
      "arg1":"\/Company\/Events\/Tradeshows\/SAR-Analytics-Symposium"
    },{
      "function":"_cn",
      "arg0":["macro",8],
      "arg1":"g-cell g-cell-1-1 g-cell-md-3-12"
    },{
      "function":"_eq",
      "arg0":["macro",6],
      "arg1":"https:\/\/www.harrisgeospatial.com"
    },{
      "function":"_cn",
      "arg0":["macro",7],
      "arg1":"\/Company\/Events\/Tradeshows\/EAS"
    },{
      "function":"_eq",
      "arg0":["macro",6],
      "arg1":"https:\/\/www.harrisgeospatial.com\/"
      ...
      "function":"_eq",
      "arg0":["macro",7],
      "arg1":"\/Industry-Solutions\/Academic"
    },{
      "function":"_eq",
      "arg0":["macro",7],
      "arg1":"\/Industry-Solutions\/Defense-Intelligence"
    },{
      "function":"_eq",
      "arg0":["macro",7],
      "arg1":"\/Industry-Solutions\/Fed-Civil"
    },{
      "function":"_eq",
      "arg0":["macro",7],
      "arg1":"\/Industry-Solutions\/Maritime"
    },{
      "function":"_eq",
      "arg0":["macro",7],
      "arg1":"\/Industry-Solutions\/Utilities"
    },{
      "function":"_eq",
      "arg0":["macro",7],
      "arg1":"\/Industry-Solutions\/Solutions-Delivery"
    },{
      "function":"_eq",
      "arg0":["macro",7],
      "arg1":"\/Industry-Solutions\/Transportation"
    },{
      "function":"_eq",
      "arg0":["macro",7],
      "arg1":"\/Industry-Solutions\/Precision-Agriculture"
    },{
      "function":"_eq",
      "arg0":["macro",7],
  ...
  "rules":[
    [["if",0],["add",0,1,2,3,4,11,12,20,21,33,14,15,16,17]],
    [["if",1,2],["add",5]],
    [["if",3,4,5],["add",6]],
    [["if",0,6],["add",7,19]],
    [["if",0,7],["add",8]],
...
function Tc(a){var b=[],c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];"AW"===d.prefix&&d.o[1]&&b.push(d.containerId)}for(var e=0;e<b.length;++e)delete a[b[e]]};var Vc={},Wc=null,Xc=Math.random();Vc.s="GTM-WNCZRSM";Vc.Cb="3b2";var Yc={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Zc="www.googletagmanager.com/gtm.js";var $c=Zc,bd=null,cd=null,dd=null,ed="//www.googletagmanager.com/a?id="+Vc.s+"&cv=71",fd={},gd={},hd=function(){var a=Wc.sequence||0;Wc.sequence=a+1;return a};var id={},jd=function(a,b){id[a]=id[a]||[];id[a][b]=!0},kd=function(a){for(var b=[],c=id[a]||[],d=0;d<c.length;d++)c[d]&&(b[Math.floor(d/6)]^=1<<d%6);for(var e=0;e<b.length;e++)b[e]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(b[e]||0);return b.join("")};
...
Z.a.ctv=["google"],function(){(function(a){Z.__ctv=a;Z.__ctv.b="ctv";Z.__ctv.g=!0;Z.__ctv.priorityOverride=0})(function(){return"71"})}();
